                ...
                <div className="h-banner-wrap">
                  <div className="h-banner-left">
                    ...
                    <h2 style={{ fontSize: '100px' }}>
                      ...
                      <a href="whatsapp://send?abid=919980619996&text=Hello!" className="h-bnr-btn">
                        <img style={{ width: '37px' }} src='images/whatsapp.png' /> +91 9980619996
                      </a>
                    </div>
          ...
          <div className="tw-any-help-section">
            <div className="container">
              <div className="tw-any-help-inner">
                ...
                <span className="tw-help-number">(9980619996)</span>
              </div>
            </div>
          </div>
