  ...
  render() {
    return (
      <div className="page-content">
        ...
        <div className="section-full p-t120 p-b90 site-bg-gray tw-booking-area" style={{ backgroundImage: "url(images/booking/bg-map.png)" }}>
                          ...
                          <form>
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-6 col-md-6">
                                <div className="mb-3">
                                  <select id="Freight_Type" defaultValue="optionValue" className="form-select">
                              ...
                              <div className="col-lg-6 col-md-6">
                                <div className="mb-3">
                                  <select id="Incoterms" defaultValue="optionValue" className="form-select">
                        ...
                        {/* <div className="booking-tab-content">
                          <form className="track-and-trace-form">
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-12 col-md-12">
                                <div className="mb-3">
                                  <select id="Shipment_Type" defaultValue="optionValue" className="form-select">
                                    <option value={1}>Shipment Type</option>
                              ...
                              <div className="col-lg-12">
                                <div className="tw-inline-checked mt-2 mb-3">
                                  <div className="mb-4 form-check">
                                    <input type="checkbox" className="form-check-input" value="" id="Fragile1" />
                                    <label className="form-check-label" htmlFor="Fragile1">Fragile</label>
                                  </div>

                                  <div className="mb-4 form-check">
                                    <input type="checkbox" className="form-check-input" value="" id="Express2" />
                                    <label className="form-check-label" htmlFor="Express2">Express Delivery</label>
                                  </div>

                                  <div className="mb-4 form-check">
                                    <input type="checkbox" className="form-check-input" value="" id="Insurance3" />
                                    <label className="form-check-label" htmlFor="Insurance3">Insurance</label>
                                  </div>

                                  <div className="mb-4 form-check">
                                    <input type="checkbox" className="form-check-input" value="" id="packaging4" />
